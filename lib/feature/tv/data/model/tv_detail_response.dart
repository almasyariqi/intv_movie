...
class TvDetailResponse {
  ...
  factory TvDetailResponse.fromJson(Map<String, dynamic> json) => TvDetailResponse(
    ...
    seasons: json["seasons"] != null ? List<TvSeason>.from(json["seasons"].map((x) => TvSeason.fromJson(x))) : [],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "origin_country": originCountries != null ? List<String>.from(originCountries!.map((x) => x)) : [],
